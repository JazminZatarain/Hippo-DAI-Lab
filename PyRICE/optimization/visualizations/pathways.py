"""
This module is used for the visualizations of optimized policies.
"""

from ema_workbench import Policy
import matplotlib.pyplot as plt
from PyRICE.model.pyrice import *
...
def load_policies_of_one_problem_formulation(file='NORDHAUS_SUFFICIENTARIAN_100000_results.csv'):
    """
    ...
    policies = [Policy(f"Nordhaus_Sufficientarian_{index}", **row) for index, row in df_policies.iterrows()]
...
def get_region_pop_gr():
    ...
    @return:
        region_pop_gr
    """
    RICE_POP_gr = pd.read_excel("./inputdata/RICE_2010_base_000.xlsm", sheet_name="Pop_gr")
...
def visualize(output_lists_WS, output_lists_WU, output_lists_NS, output_lists_NU, saving=False):
    """
    ...
    visualize_one_column(output_lists_NS, axes, column_index=2, problem_formulation='NS')
    visualize_one_column(output_lists_NU, axes, column_index=3, problem_formulation='NU')
...
if __name__ == '__main__':
    ...
    visualize(output_lists_WS, output_lists_WU, output_lists_NS, output_lists_NU, saving=False)
